...
class StermScreen extends StatefulWidget {
  ...
  @override
  State<StermScreen> createState() => _StermScreenState();
}

class _StermScreenState extends State<StermScreen> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: !_termsReaded ? null : () => widget.onChangedStep(6),
                child: Text(
