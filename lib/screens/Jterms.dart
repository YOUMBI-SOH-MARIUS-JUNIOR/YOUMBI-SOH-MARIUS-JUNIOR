...
class JtermScreen extends StatefulWidget {
  ...
  @override
  State<JtermScreen> createState() => _JtermScreenState();
}

class _JtermScreenState extends State<JtermScreen> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: !_termsReaded ? null : () => widget.onChangedStep(5),
                child: Text(
