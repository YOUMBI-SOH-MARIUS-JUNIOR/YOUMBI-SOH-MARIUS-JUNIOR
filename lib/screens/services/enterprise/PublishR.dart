...
class RpublishScreen extends StatefulWidget {
  final Function(int) onChangedStep;
  const RpublishScreen({super.key, required this.onChangedStep});

  @override
  State<RpublishScreen> createState() => _RpublishScreenState();
}

class _RpublishScreenState extends State<RpublishScreen> {
