...
class IpublishScreen extends StatefulWidget {
  final Function(int) onChangedStep;
  const IpublishScreen({super.key, required this.onChangedStep});

  @override
  State<IpublishScreen> createState() => _IpublishScreenState();
}

class _IpublishScreenState extends State<IpublishScreen> {
