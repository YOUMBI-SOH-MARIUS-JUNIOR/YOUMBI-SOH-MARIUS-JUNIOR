...
class SpublishScreen extends StatefulWidget {
  final Function(int) onChangedStep;
  const SpublishScreen({super.key, required this.onChangedStep});

  @override
  State<SpublishScreen> createState() => _SpublishScreenState();
}

class _SpublishScreenState extends State<SpublishScreen> {
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText:
                                  '\n\nEnter your report here in English .',
