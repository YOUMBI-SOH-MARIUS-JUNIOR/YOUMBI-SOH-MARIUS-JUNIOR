...
class JnavigationScreen extends StatefulWidget {
  final Function(int) onChangedStep;
  const JnavigationScreen({super.key, required this.onChangedStep});

  @override
  State<JnavigationScreen> createState() => _JnavigationScreen();
}

class _JnavigationScreen extends State<JnavigationScreen> {
